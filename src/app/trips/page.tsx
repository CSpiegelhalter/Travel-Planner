...
function trips() {
  ...
  const TripsDefault = dynamic(() => import('@/components/Tripspage/TripsDefault/TripsDefault'))
  const CreateTrip = dynamic(() => import('@/components/Tripspage/CreateTrip/CreateTrip'))
